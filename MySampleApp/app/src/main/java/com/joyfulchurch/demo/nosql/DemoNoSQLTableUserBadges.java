package com.joyfulchurch.demo.nosql;
...
public class DemoNoSQLTableUserBadges extends DemoNoSQLTableBase {
    private static final String LOG_TAG = DemoNoSQLTableUserBadges.class.getSimpleName();
    ...
    public class DemoGetWithPartitionKeyAndSortKey extends DemoNoSQLOperationBase {
        ...
        DemoGetWithPartitionKeyAndSortKey(final Context context) {
            super(context.getString(R.string.nosql_operation_get_by_partition_and_sort_text),
                String.format(context.getString(R.string.nosql_operation_example_get_by_partition_and_sort_text),
                    ...
                    "deviceToken", "demo-userId-500000"));
        }

        @Override
        public boolean executeOperation() {
            // Retrieve an item by passing the partition key using the object mapper.
            result = mapper.load(UserBadgesDO.class, AWSMobileClient.defaultMobileClient().getIdentityManager().getCachedUserID(), "demo-deviceToken-500000");
        ...
        public List<DemoNoSQLResult> getNextResultGroup() {
            ...
            results.add(new DemoNoSQLUserBadgesResult(result));
    ...
    public class DemoQueryWithPartitionKeyAndSortKeyCondition extends DemoNoSQLOperationBase {
        ...
        private PaginatedQueryList<UserBadgesDO> results;
        private Iterator<UserBadgesDO> resultsIterator;
        ...
        @Override
        public boolean executeOperation() {
            final UserBadgesDO itemToFind = new UserBadgesDO();
            itemToFind.setUserId(AWSMobileClient.defaultMobileClient().getIdentityManager().getCachedUserID());

            final Condition rangeKeyCondition = new Condition()
                .withComparisonOperator(ComparisonOperator.LT.toString())
                .withAttributeValueList(new AttributeValue().withS("demo-deviceToken-500000"));
            final DynamoDBQueryExpression<UserBadgesDO> queryExpression = new DynamoDBQueryExpression<UserBadgesDO>()
                .withHashKeyValues(itemToFind)
                .withRangeKeyCondition("deviceToken", rangeKeyCondition)
                .withConsistentRead(false)
                .withLimit(RESULTS_PER_RESULT_GROUP);

            results = mapper.query(UserBadgesDO.class, queryExpression);
            if (results != null) {
    ...
    public class DemoQueryWithPartitionKeyAndFilter extends DemoNoSQLOperationBase {
        ...
        public boolean executeOperation() {
            ...
            filterExpressionAttributeNames.put("#badgeCount", "badgeCount");

            final Map<String, AttributeValue> filterExpressionAttributeValues = new HashMap<>();
            filterExpressionAttributeValues.put(":MinbadgeCount",
                new AttributeValue().withN("1111500000"));

            final DynamoDBQueryExpression<UserBadgesDO> queryExpression = new DynamoDBQueryExpression<UserBadgesDO>()
                .withHashKeyValues(itemToFind)
                .withFilterExpression("#badgeCount > :MinbadgeCount")
    ...
    public class DemoDeviceTokenQueryWithPartitionKeyOnly extends DemoNoSQLOperationBase {

        private PaginatedQueryList<UserBadgesDO> results;
        private Iterator<UserBadgesDO> resultsIterator;

        DemoDeviceTokenQueryWithPartitionKeyOnly(final Context context) {
            super(
        ...
        public boolean executeOperation() {
            ...
            DynamoDBQueryExpression<UserBadgesDO> queryExpression = new DynamoDBQueryExpression<UserBadgesDO>()
                .withHashKeyValues(itemToFind)
                .withConsistentRead(false);
            results = mapper.query(UserBadgesDO.class, queryExpression);
            if (results != null) {
    ...
    public class DemoDeviceTokenQueryWithPartitionKeyAndFilterCondition extends DemoNoSQLOperationBase {

        private PaginatedQueryList<UserBadgesDO> results;
        private Iterator<UserBadgesDO> resultsIterator;

        DemoDeviceTokenQueryWithPartitionKeyAndFilterCondition (final Context context) {
            super(
    ...
    public class DemoScanWithFilter extends DemoNoSQLOperationBase {
        ...
        private PaginatedScanList<UserBadgesDO> results;
        private Iterator<UserBadgesDO> resultsIterator;
        ...
        public boolean executeOperation() {
            ...
            results = mapper.scan(UserBadgesDO.class, scanExpression);
            if (results != null) {
                resultsIterator = results.iterator();
                if (resultsIterator.hasNext()) {
                    return true;
     ...
     */
    private static List<DemoNoSQLResult> getNextResultsGroupFromIterator(final Iterator<UserBadgesDO> resultsIterator) {
        if (!resultsIterator.hasNext()) {
            return null;
        }
        ...
        do {
            ...
            final UserBadgesDO item = resultsIterator.next();
            // Add the item to a group of results that will be displayed later.
            resultGroup.add(new DemoNoSQLUserBadgesResult(item));
            itemsRetrieved++;
    ...
    public DemoNoSQLTableUserBadges() {
    ...
    public void insertSampleData() throws AmazonClientException {
        ...
        final UserBadgesDO firstItem = new UserBadgesDO();

        firstItem.setUserId(AWSMobileClient.defaultMobileClient().getIdentityManager().getCachedUserID());
        firstItem.setDeviceToken("demo-deviceToken-500000");
        firstItem.setBadgeCount(DemoSampleDataGenerator.getRandomSampleNumber());
        firstItem.setLastUpdated(DemoSampleDataGenerator.getRandomSampleNumber());
        ...
        final UserBadgesDO[] items = new UserBadgesDO[SAMPLE_DATA_ENTRIES_PER_INSERT-1];
        for (int count = 0; count < SAMPLE_DATA_ENTRIES_PER_INSERT-1; count++) {
            final UserBadgesDO item = new UserBadgesDO();
            ...
            item.setBadgeCount(DemoSampleDataGenerator.getRandomSampleNumber());
            item.setLastUpdated(DemoSampleDataGenerator.getRandomSampleNumber());
    ...
    public void removeSampleData() throws AmazonClientException {
        ...
        final PaginatedQueryList<UserBadgesDO> results = mapper.query(UserBadgesDO.class, queryExpression);

        Iterator<UserBadgesDO> resultsIterator = results.iterator();
        ...
        final List<UserBadgesDO> batchOfItems = new LinkedList<UserBadgesDO>();
    ...
    private List<DemoNoSQLOperationListItem> getSupportedDemoOperations(final Context context) {
        ...
        noSQLOperationsList.add(new DemoNoSQLOperationListHeader(
            context.getString(R.string.nosql_operation_header_secondary_queries, "deviceToken")));

        noSQLOperationsList.add(new DemoDeviceTokenQueryWithPartitionKeyOnly(context));
        noSQLOperationsList.add(new DemoDeviceTokenQueryWithPartitionKeyAndFilterCondition(context));
        noSQLOperationsList.add(new DemoNoSQLOperationListHeader(
